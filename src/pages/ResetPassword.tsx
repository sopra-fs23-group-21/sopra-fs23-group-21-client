...
export default function ResetPassword() {
  ...
  const [_, setAdminData] = useLocalStorage<AdminProps | undefined>(
    "adminData",
    undefined
  );
    ...
    <VStack minH="100vh" minW="fit-content" p={10} spacing={8}>
      <VStack>
        ...
        <Text color="gray.600" textAlign="center" lineHeight={1.5} w="lg">
          In order to gain full access to your account, we need you to complete
          your registration by providing a password.
        </Text>
      </VStack>
      <Formik
