...
1. Our poker game is a three-player game. To start the game, all three players must be online at the same time, enter the same game room, and click ready（the '准备 Ready?' button is unavailable until there are three players in the same game room）. If only one or two players are present, or if all three players are not online at the same time, the game cannot be played.<br/>
<br/>
